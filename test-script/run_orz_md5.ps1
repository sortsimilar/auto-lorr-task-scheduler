# MAPF Test Script for ORZ map
# Tests orz map only, saves to orz_round/

$PROJ_DIR = "C:\Users\Administrator\Desktop\test-studio-mapf\LORR26_842072627"
$SRC_DIR = "$PROJ_DIR\src"
$LIFELONG = "$PROJ_DIR\build\lifelong.exe"
$OUTPUT_BASE = "C:\Users\Administrator\Desktop\test-studio-mapf\test-scripts\orz_round"
...
Write-Host "MAPF Orz Test (round$ROUND) - MD5: $MD5"

$map = @{name="orz"; dir="game.domain"; file="orz-example_1800.json"; steps=400}
$oldLoc = Get-Location
