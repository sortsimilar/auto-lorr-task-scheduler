# MAPF Test Script for BOS map
# Tests bos map only, saves to bos_round/

$PROJ_DIR = "C:\Users\Administrator\Desktop\test-studio-mapf\LORR26_842072627"
$SRC_DIR = "$PROJ_DIR\src"
$LIFELONG = "$PROJ_DIR\build\lifelong.exe"
$OUTPUT_BASE = "C:\Users\Administrator\Desktop\test-studio-mapf\test-scripts\bos_round"
...
Write-Host "MAPF Bos Test (round$ROUND) - MD5: $MD5"

$map = @{name="bos"; dir="city.domain"; file="bos-example_600.json"; steps=700}
$oldLoc = Get-Location
