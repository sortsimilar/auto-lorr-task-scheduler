# MAPF Test Script for RANDOM map
# Tests random map only, saves to random_round/

$PROJ_DIR = "C:\Users\Administrator\Desktop\test-studio-mapf\LORR26_842072627"
$SRC_DIR = "$PROJ_DIR\src"
$LIFELONG = "$PROJ_DIR\build\lifelong.exe"
$OUTPUT_BASE = "C:\Users\Administrator\Desktop\test-studio-mapf\test-scripts\random_round"
...
Write-Host "MAPF Random Test (round$ROUND) - MD5: $MD5"

# Test random map
$map = @{name="random"; dir="random.domain"; file="random-example_400.json"; steps=300}
$oldLoc = Get-Location
